...
export function WhatsAppButton({ 
  ...
  useEffect(() => {
    ...
    const hideTimer = setTimeout(() => {
      ...
      // Show again after 30 seconds if not manually closed
      if (!hasClosedTooltip) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <div 
        className={`
          bg-white rounded-lg shadow-lg border border-gray-100 p-3 pr-8 max-w-[260px]
      ...
      <button
        onClick={handleClick}
        className="group relative w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 flex items-center justify-center"
